import { clip, vcover1, vcover2, vcover3 } from "@/assets/videos";
import {
  heroimg,
  hightlightimg,
  sneakershoe,
...
import { IFooterAPI, IHeroapi, IHighlight, ISales, IStory } from "@/types";
...
const heroapi: IHeroapi = {
  ...
  sociallinks: [
    ...
    { icon: messenger, link: "#", name: "Messenger" },
